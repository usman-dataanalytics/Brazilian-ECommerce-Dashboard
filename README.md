...
- 93.4% of orders delivered on time

## Dashboard Pages
- Page 1: Summary — KPI overview, sales trend, category and payment analysis
- Page 2: Sales Details — state-wise performance, review scores, product breakdown
- Page 3: Order and Delivery Analysis — order status, timely delivery counts
- Page 4: Payment Method Analysis — payment type breakdown
